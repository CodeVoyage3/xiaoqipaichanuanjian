...
if ($version -ne '1.0.3' -or $manifestObject.source.minVersion -ne '1.0.2' -or $manifestObject.source.maxVersion -ne '1.0.2' -or @($manifestObject.targetMigrations).Count -ne 9) { throw 'Release manifest version contract is not frozen for v1.0.2 to v1.0.3.' }
