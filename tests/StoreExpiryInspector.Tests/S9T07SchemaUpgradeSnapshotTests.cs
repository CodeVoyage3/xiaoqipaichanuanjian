...
public sealed class S9T07SchemaUpgradeSnapshotTests
{
    ...
    public async Task RealAppMaintenancePreparerAndExternalUpdaterCommitFixture10()
    {
        ...
        try
        {
            ...
            Assert.Equal(new Version(1, 0, 3, 0), AssemblyName.GetAssemblyName(Path.Combine(app, "StoreExpiryInspector.dll")).Version); Assert.Equal(new Version(1, 0, 4, 0), AssemblyName.GetAssemblyName(Path.Combine(fixture, "StoreExpiryInspector.dll")).Version);
