...
public sealed class S9T04SignedUpdatePackageTests
{
    ...
    private sealed class Routes(byte[]? manifest = null, byte[]? signature = null, byte[]? package = null) : HttpMessageHandler
    {
        ...
        protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            if (request.RequestUri.Host == "api.github.com") return Task.FromResult(Bytes(HttpStatusCode.OK, Encoding.UTF8.GetBytes("{\"id\":7,\"tag_name\":\"v1.0.0\",\"draft\":false,\"prerelease\":false,\"assets\":[{\"name\":\"update-manifest.json\",\"browser_download_url\":\"https://github.com/CodeVoyage3/xiaoqipaichanuanjian/releases/download/v1.0.0/update-manifest.json\"},{\"name\":\"update-manifest.sig\",\"browser_download_url\":\"https://github.com/CodeVoyage3/xiaoqipaichanuanjian/releases/download/v1.0.0/update-manifest.sig\"},{\"name\":\"StoreExpiryInspector-1.0.0-win-x64.zip\",\"browser_download_url\":\"https://github.com/CodeVoyage3/xiaoqipaichanuanjian/releases/download/v1.0.0/StoreExpiryInspector-1.0.0-win-x64.zip\"}]}")));
