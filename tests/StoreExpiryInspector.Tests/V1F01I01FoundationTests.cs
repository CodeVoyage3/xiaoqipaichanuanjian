...
public sealed class V1F01I01FoundationTests
{
    ...
    public void ProductAndBaselineConstraintsArePersistedBySqlite()
    {
        ...
        context.SaveChanges();
        context.BatchBaselines.Add(new BatchBaseline { BaselineId = baseline.Id, BatchId = batch.Id, StageAtBaseline = ExpiryStageCalculator.Expired, ColdStartDisposition = ColdStartDispositions.ExpiredCatchupTask, CatchupWindowDays = 3, CatchupSource = "historical_window" });
        context.SaveChanges();
