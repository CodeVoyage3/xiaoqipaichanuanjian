...
> 2026-09-04 Stage9修订：用户已授权“安装、发布与在线升级交付”及S9-T01。D-007原“V1不做在线升级”被新产品决策覆盖：首次当前用户安装EXE，后续GitHub在线检查、用户确认后自动下载校验升级、可稍后提醒；核心业务完全离线，无后台静默强制升级。实现状态见S9-T01 Acceptance，安装与更新架构见ANALYSIS/S9-T01-UPDATE-ARCHITECTURE.md。Import Undo永久取消、重置数据另立需求；下方旧状态仅为历史。
...
- 安装：Stage 9 使用 Inno Setup。历史“V1 不做在线升级”已由2026-09-04用户决策覆盖，现支持用户确认后的在线升级，详见总纲第37节。
