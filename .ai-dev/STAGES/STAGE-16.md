...
Stage16 = `IN_PROGRESS / WAITING_USER_GUI_ACCEPTANCE`

用户首轮 GUI 验收失败事实已记录；返修已完成并通过 Sol 独立技术验收。S16-T01 = `IMPLEMENTED / TECHNICAL_ACCEPTANCE_READY / NOT_ACCEPTED`，等待用户使用新入口复验；S16-T02 继续 `PLANNED / NOT_DISPATCHED`。
