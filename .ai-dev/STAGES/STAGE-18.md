...
v1.0.9=`RELEASED`。唯一 PRODUCT SOURCE=`9bf4ee71f1579097d816032d867041c0519cf789`；App/Updater=`1.0.9 / 1.0.9.0`；annotated tag `v1.0.9` 精确解引用到 PRODUCT SOURCE；GitHub Release ID=`386762247`，stable/latest=`v1.0.9`。

冻结四资产与 GitHub 公网匿名 fresh 下载 bytes/SHA256 逐项全等，production RSA-PSS/SHA256 signature=`PASS`：ZIP `109433662` / `71923637759B9E90D41C4293F01CAE8329F69DE77B50E6DB699D8C832E3A6D55`；Setup `75331419` / `9979AC7CD6B48FB6DF74CF218A8B7F7926FF315402DD738EA19CD84ADCE3BBEF`；manifest `869` / `95E909DE059EC0D3F70430FC3145ECCF8C5806AF73966EB47D20D0F4A0093C97`；signature `384` / `B71713E86756832B080278D1207BFE24E5E784F9F8D431D35019305E2CB6CE04`。

夸克正式分享 <https://pan.quark.cn/s/be348f33499a>；Gitee `master/latest.json` commit `dd8afd8a9d6c1651f6ec117aef6d80d50097781d`，固定 Raw 匿名 HTTP `200` 且三字段精确一致。Schema/migration=`NO CHANGE / 9`；正式数据库=`NO ACCESS`；`FULL=NOT_RUN / NO_FULL`；正式 dirty 工作区保持未触碰。
...
R1 implementation=`733bc909b0f4b487508b69ddc3ed2f87d08538cd` 已完成：两项最小静态契约=`2/2 PASS`，Release App build=`0 warning / 0 error`，纯 GUID 隔离启动 preflight=`PASS`。S18-T03=`R1_TECHNICAL_ACCEPTANCE_READY / NOT_ACCEPTED`；当前只等待用户 A～D。
