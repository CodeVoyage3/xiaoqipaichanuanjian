...
- S5-T03 已实现排查历史只读入口、列表、正式详情与 Revision 展示；实现 `3f44388193fc03cfde82ee169912f868ba32e219`。Sol 独立专项 10/10、S5-T02 16/16、S5-T01 9/9、Stage 4 179/179、Stage 3 170/170、Release 567/567、build 0/0、EF 无漂移、migration 8、无依赖变更；没有历史编辑 UI 或 S5-T04。GUI 尚待用户本人验收，不计为正式完成。
...
- 后续用户确认无修改记录、返回列表、复制正常，但反馈多列表头遮挡；原 Luna 在 `e4c3d4d8d6b18c3fc9e1f9773815d6fde11430ae` 修复历史页三表的自适应列宽、局部对齐和滚动，未缩小字号/隐藏字段/改全局样式。本轮 Sol 专项 10/10、16/16、9/9，Stage 4 179/179、Stage 3 170/170、全量 567/567、build 0/0，EF/migration/dependency 均保持门禁；三个旧列宽逐项反向验证失败，修复版通过。隔离 EXE/DLL/PDB 和启动哈希已同步，进程 0，等待用户 GUI 显示重验。
- 正式库仍旁置保护，未写入演示数据；隔离测试库已获批准并具备 1 条正式记录、3 条明细和 2 次 Revision。用户本机与工具侧 C 盘视图不同，工具侧失败 Junction 尚待解决；正式运行环境尚未恢复。重验后须确认进程为 0、清理隔离数据、恢复正式库并核验 299008 bytes / 指定 SHA-256，恢复后不再启动。Sol 不启动 WPF、不使用电脑操控验收。
- 不得创建、编号、派发或实施 S5-T04，等待用户下一步批准。历史页全部只读，不得接入历史编辑或生命周期联动。
